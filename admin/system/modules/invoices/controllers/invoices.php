 ...
 * @since   Version 0.5
 * @filesource system/modules/invoices/controllers/invoices.php
 */
...
Class Invoices extends TOC_Controller
{
  ...
  {
    $this->load->view('main');
    $this->load->view('invoices_grid');
    $this->load->view('orders/orders_products_grid');
    $this->load->view('orders/orders_transaction_grid');
    $this->load->view('invoices_status_panel');
    $this->load->view('invoices_dialog');
  }
  ...
  public function list_invoices()
  {
    ...
    return array(EXT_JSON_READER_TOTAL => $this->invoices_model->get_total($orders_id, $customers_id, $status),
...
/* Location: system/modules/invoices/controllers/invoices.php */
