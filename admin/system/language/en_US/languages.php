...
heading_languages_title = Languages
tree_head_title = Languages
heading_translations_title = Languages Translations
...
table_heading_definition_key = Key
table_heading_definition_value = Value

action_heading_import_language = Import Language
action_heading_upload_language = Upload Language
...
action_heading_add_definition = Add Language Definition
field_group_selection = Definition Groups:
...
field_language_zip_file = Language Zip File:
...
introduction_upload_language = Please click "Browse" to choose the zipped language package on your hard drive. If you want to import other languages, please go to <a href="http://www.tomatocart.com/translator" target="_blank"><b>TomatoCart Online Translator</b></a> to export one.

ms_error_creating_directory_failed = Error: The cache directory is not writable: %s
ms_error_wrong_language_package = Zip file format error.

ms_upload_language_not_exists = Download Languages files failed.
ms_error_upload_language_decompression = Extract the files wrong.

ms_file_format_error = File format Error.
ms_error_upload_file_not_saved = Saved File Error. 
