 ...
 */
class Modules_Payment extends TOC_Controller
{
    /**
     * Constructor
     *
    ...
    public function install()
    {
        ...
        include_once '../system/tomatocart/libraries/payment/payment_' . $code . '.php';
        $class = config_item('subclass_prefix') . 'Payment_'. $code;
    ...
    function save()
    {
        ...
        if ($this->extensions_model->save('payment', $code, json_encode($configurations))) 
        {
            $response = array('success' => true, 'feedback' => lang('ms_success_action_performed'));
        } 
        else 
    ...
    function get_configuration_options()
    {
        ...
        //load language xml file
        $this->lang->xml_load('modules/payment/' . $code);
        
        //include file
        require_once '../system/tomatocart/libraries/payment/payment_' . $code . '.php';
