...
/*
 *---------------------------------------------------------------
 * LOCAL APPLICATION FOLDER NAME
 *---------------------------------------------------------------
 *
 * The local application override TomatoCart
 *
 * NO TRAILING SLASH!
 */
	$local_application_folder = 'local';
 ...
 *---------------------------------------------------------------
 * This path is used to get the resources such as script, image, css etc.
 */
...
/*
 *---------------------------------------------------------------
 * The images http path for the site
 *---------------------------------------------------------------
 * This path is used to get the resources such as script, image, css etc.
 */
    ...
    $img_http_path = $protocol . rtrim(str_replace('admin', '', $_SERVER['SERVER_NAME']), '/') . '/images/';

/*
 *---------------------------------------------------------------
 * LOCAL APPLICATION FOLDER CONSTANTS
 *---------------------------------------------------------------
 */
...
/*
 *---------------------------------------------------------------
 * IMG PATH URL CONSTANTS
 *---------------------------------------------------------------
 */  
    define('IMGHTTPPATH' , str_replace("\\", "/", $img_http_path));
